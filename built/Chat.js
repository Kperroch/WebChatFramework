...
var Chat = (function (_super) {
    ...
    function Chat(props) {
        ...
        _this._handleDragOver = _this.onDragOver.bind(_this);
        _this._handleOnDrop = _this.onDrop.bind(_this);
    ...
    Chat.prototype.render = function () {
        ...
        return (React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement("div", { className: "wc-chatview-panel", onKeyDownCapture: this._handleKeyDownCapture, onDragOver: this._handleDragOver, onDrop: this._handleOnDrop, ref: this._saveChatviewPanelRef },
                ...
                React.createElement(MessagePane_1.MessagePane, { disabled: this.props.disabled },
                    React.createElement(History_1.History, { disabled: this.props.disabled, onCardAction: this._handleCardAction, ref: this._saveHistoryRef })),
                !this.props.disabled && React.createElement(Shell_1.Shell, { ref: this._saveShellRef }),
